...
if __name__ == '__main__': 
    ...
    spatialFilter =  {'filterType' : "mbr",
                      'lowerLeft' : {'latitude' : 43, 'longitude' : -122},
                      'upperRight' : { 'latitude' : 44, 'longitude' : -121}}
                     
    temporalFilter = {'start' : '2000-02-10', 'end' : '2000-02-23'}
